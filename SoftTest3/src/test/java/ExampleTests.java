...
public class ExampleTests {
	 ...
	 */
	private String pathFile = "C:\\Users\\YztHowe\\Desktop\\Code\\Code\\SoftTest3\\src\\test\\java\\Example.java";
	////////////
	 ...
	 */
	private YeZhenghao yeZhenghao = new YeZhenghao();
	...
	{
		int[][] source = yeZhenghao.getControlFlowGraphInArray(pathFile, methodName1);
	...
	{
		int[][] source = yeZhenghao.getTestRequirementsInArray(pathFile, methodName1);
	...
	public void testTestPaths()
	{
		int nodeStart = 0;
		int nodeEnd = 2;
		int[][] source = yeZhenghao.getTestPathsInArray(pathFile, methodName1);
